...
/**
 * @Sandbox component of Asciiscript (uses Jailed by https://github.com/asvd)
...
(function (root, factory) {
    ...
    var initNode = function() {
        require('https://sandbox-api.glitch.me/_JailedSite.js');
    }
    ...
    var initWeb = function() {
        ...
        window.onload = function(){
            origOnload();
            load(
                'https://sandbox-api.glitch.me/_JailedSite.js',
    ...
    var basicConnectionNode = function() {
        ...
        BasicConnection = function() {
            ...
            this._process = childProcess.fork(
               'https://sandbox-api.glitch.me/_pluginNode.js'
            );
    ...
    DynamicPlugin.prototype._init =
        ...
        this._connection.importScript(
          'https://sandbox-api.glitch.me/_JailedSite.js', sCb, this._fCb
        );
    }
    ...
    DynamicPlugin.prototype._loadCore =
        ...
        this._connection.importScript(
            "https://sandbox-api.glitch.me/_pluginCore.js", sCb, this._fCb
        );
    }
...
var reset = function() {
    requests = 0;
    plugin = new jailed.Plugin('https://sandbox-api.glitch.me/plugin.js', api);
